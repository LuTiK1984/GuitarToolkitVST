...
This section contains documentation for preparing and publishing GuitarToolkit releases.
...
[English version](#release-documentation)

Этот раздел содержит документацию для подготовки и публикации релизов GuitarToolkit.
